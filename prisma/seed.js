...
//MyNotes :
//Seeding process in Prisma means that initial we are adding some dummy data to our database.
/*
    Suppose , when you deploy ur application , then at time 0 users are there and then products will be displaying as 0 
    so , what we do is Seeding ! , means we create (POST) some initial data to the database.
