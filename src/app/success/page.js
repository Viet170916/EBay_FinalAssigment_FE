        ...
        <>
            <MainLayout>
                <div id='SuccessPage' className='mt-12 max-w-[1200px] mx-auto px-2 min-h-[50vh]'>
                    <div className='bg-white w-full p-5 min-h-[150px] flex items-center justify-center'>
                         <div>
                            ...
                            <Link href={'/'} className='w-full'>
                                <div className='w-full text-center bg-blue-600 text-sm font-semibold text-white mt-4 p-[11px]'>
                                    Back to shop
                                </div>
                            </Link>
                         </div>
